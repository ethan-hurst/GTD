		...
		<div class="border-t border-gray-200 dark:border-gray-800 px-4 py-4 space-y-4 bg-gray-50 dark:bg-gray-900/50">
			...
			<div>
				...
				<textarea
					...
					class="w-full px-3 py-2 text-sm border border-gray-300 dark:border-gray-600 rounded-md bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 placeholder-gray-400 dark:placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent resize-y min-h-[80px]"
				/>
			</div>
			...
			<div class="flex justify-end pt-2">
				<button
					...
					class="px-3 py-1.5 text-sm font-medium text-red-700 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-900/20 rounded-md transition-colors flex items-center gap-1"
				>
