...
<footer class="border-t border-gray-100 dark:border-gray-800/50 bg-gray-50/50 dark:bg-gray-900/50 h-9 flex flex-wrap items-center gap-2 px-3 tablet:px-6 py-1.5 text-xs tablet:text-sm text-gray-400 dark:text-gray-500">
	<!-- Persistence Status -->
