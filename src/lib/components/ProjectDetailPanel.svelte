			...
			<div class="space-y-4">
				...
				<div class="flex flex-col gap-2 pt-2 sticky bottom-0 bg-white dark:bg-gray-950 pb-4">
					...
					<button
						...
						class="w-full min-h-11 px-4 py-2.5 text-base font-medium text-white bg-green-600 hover:bg-green-700 rounded-md transition-colors focus:outline-none focus:ring-2 focus:ring-green-500/40 focus:ring-offset-2"
					>
						Complete
					</button>
					<button
						onclick={handleMoveToSomeday}
						class="w-full min-h-11 px-4 py-2.5 text-base font-medium text-white bg-amber-600 hover:bg-amber-700 dark:bg-amber-500 rounded-md transition-colors focus:outline-none focus:ring-2 focus:ring-amber-500/40 focus:ring-offset-2"
					>
						Someday/Maybe
					</button>
					<button
